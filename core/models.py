"""
core/models.py — Database models for the College Canteen Management System
"""
...
class User(AbstractUser):
    """Extended user model supporting 4 roles."""
    ...
    def is_canteen_staff(self):
        return self.role == self.ROLE_CANTEEN
...
class Category(models.Model):
    ...
    icon = models.CharField(max_length=50, blank=True, help_text="Bootstrap icon name, e.g. bi-cup-hot")
...
class Order(models.Model):
    """A complete order placed by a student."""
...
class Payment(models.Model):
    """Mock payment record linked to an order."""
