...
ALLOWED_HOSTS = [
    ...
    "canteen-production-295d.up.railway.app",
    "127.0.0.1",
    "localhost",
]
...
CSRF_TRUSTED_ORIGINS = [
    ...
    "https://canteen-production-295d.up.railway.app",
]
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('SUPABASE_SQL', os.environ.get('DATABASE_URL', 'sqlite:///db.sqlite3')),
        conn_max_age=600,
        ssl_require=True,
    )
}
